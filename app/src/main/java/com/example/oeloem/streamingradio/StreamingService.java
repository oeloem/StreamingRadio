...
public abstract class StreamingService extends Service implements MediaPlayer.OnCompletionListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnInfoListener, MediaPlayer.OnBufferingUpdateListener {
    ...
    private void showNotif(String name) {
        ...
        builder.setSmallIcon(android.R.drawable.ic_media_play)
                ...
                .setContentText("By Rosihululum.com")
